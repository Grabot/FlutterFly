...
import 'package:flutterfly/util/logo.dart';
              ...
              child: Container(
                ...
                child: const Column(
                  ...
                  children: [
                    SizedBox(height: 10),
                    Text(
                        "End-User License Agreement (EULA) of FlutterFly",
                    ...
                    SizedBox(height: 10),
                    Text(
                        "This EULA agreement governs your acquisition and use of our FlutterFly software (\"Software\") directly from Zwaar developers or indirectly through a Zwaar developers authorized reseller or distributor (a \"Reseller\").",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                        "Please read this EULA agreement carefully before completing the installation process and using the FlutterFly software. It provides a license to use the FlutterFly software and contains warranty information and liability disclaimers.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                        "If you register for a free trial of the FlutterFly software, this EULA agreement will also govern that trial. By clicking \"accept\" or installing and/or using the FlutterFly software, you are confirming your acceptance of the Software and agreeing to become bound by the terms of this EULA agreement.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                    ...
                    SizedBox(height: 10),
                    Text(
                        "Zwaar developers hereby grants you a personal, non-transferable, non-exclusive licence to use the FlutterFly software on your devices in accordance with the terms of this EULA agreement.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
                        "You are permitted to load the FlutterFly software (for example a PC, laptop, mobile or tablet) under your control. You are responsible for ensuring your device meets the minimum requirements of the FlutterFly software.",
                        style: TextStyle(color: Color(0xfff1f1f1), fontSize: 16)
                    ),
                    SizedBox(height: 10),
                    Text(
